    ...
    return (
        <div className="relative flex items-center justify-center">
            ...
            <button
                ...
                className="relative z-20 flex items-center justify-center px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-500 shadow-[0_0_20px_rgba(255,255,255,0.1)] cursor-pointer bg-white text-slate-900 hover:scale-105"
            >
