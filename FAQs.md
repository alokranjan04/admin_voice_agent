# Voice AI Platform | Enterprise AI FAQs

## 1. What is Voice AI Platform?
Voice AI Platform is our premium enterprise AI division focused on deploying autonomous voice agents that handle complex customer interactions with human-level nuance and machine precision.
...
Yes. Voice AI Platform natively supports English, Hindi, Spanish, French, German, and Arabic, with seamless transition between languages during a live session.
...
Absolutely. Voice AI Platform is SOC2 Type II compliant, HIPAA ready, and PCI DSS v4.0 certified. All data is encrypted at rest and in transit.
